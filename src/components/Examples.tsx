...
export default function Examples({ summary, chapters, questions }: { summary: string, chapters: string, questions: string }) {
        ...
        {examples.map((example, i) => (
          ...
          >
            ...
            <div className="flex flex-1 flex-col p-1">
              ...
              >
                {expandedItems[example.name] ? 'Show Less' : 'Show More'}
              </button>
            </dd>
              </dl>
            </div>
